// Reference: This code is origin from libp2p example https://github.com/libp2p/js-libp2p-examples/blob/master/chat/nodejs/08-End/chat.js
...
class Chat {
  ...
  assign(libp2p, topic, messageHandler) {
    this.libp2p = libp2p
    this.topic = topic
